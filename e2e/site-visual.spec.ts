...
import { maximizeTerminal } from './helpers/terminal';
import { waitForStableScreenPage } from './helpers/visual';
...
test.describe('screen visual regressions', () => {
  ...
  test('projects index hero matches snapshot', async ({ page }) => {
    await waitForStableScreenPage(page, '/projects');
  ...
  test('project detail hero matches snapshot', async ({ page }) => {
    await waitForStableScreenPage(page, '/projects/spear-dashboard');
  ...
  test('404 page matches snapshot', async ({ page }) => {
    await waitForStableScreenPage(page, '/nonexistent');
